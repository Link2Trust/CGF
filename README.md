...
# Cryptographic Governance Framework (CGF)

The **Cryptographic Governance Framework (CGF)** is a comprehensive suite of standards, policies, and procedures designed to ensure cryptographic controls are consistently managed, securely implemented, and compliant with internal and external requirements. It defines key processes for cryptographic lifecycle management, from policy establishment to key decommissioning.
...
- Protect company information assets using cryptographic mechanisms.
- Define governance and operational procedures for cryptographic key and asset management.
- Support compliance, resilience, and interoperability across business units and third parties.
- Lay a foundation for quantum-resilient infrastructure and crypto-agility.
...
|----------|-------------|
| **Cryptography Policy** | Sets out requirements for cryptographic controls to protect company information. |
| **Cryptographic Functional Standard** | Establishes baseline requirements for management of cryptographic systems and keys. |
| **Roles and Responsibilities** | Defines internal roles for managing cryptographic assets, services, and responsibilities. |
| **Approved Cryptographic Mechanisms** | Lists authorized algorithms and mechanisms used within the company. |
...
## 📖 Supporting Guides and Standards
...
- Enhances protection of data and infrastructure.
- Enables efficient incident response.
- Ensures alignment with compliance and audit requirements.
- Supports crypto-agility and future-readiness (e.g., post-quantum cryptography).
